...
targets/arm/CMakeFiles/arm.flash_stlink: build/arm/bin/arm
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\Users\eitowiec\Desktop\02_zumo\03_zumo_NEW_IMPL\cmake-build-debug\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Flashing target hardware"
	cd /d C:\Users\eitowiec\Desktop\02_zumo\03_zumo_NEW_IMPL\cmake-build-debug\build\arm\bin && openocd -f interface/stlink-v2-1.cfg -c "transport select hla_swd" -f target/stm32f3x.cfg -c init -c "reset halt" -c "flash write_image erase arm" -c "reset run" -c shutdown
